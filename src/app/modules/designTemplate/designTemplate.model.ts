...
import { IDesignTemplate, DESIGN_PLATFORM_OPTIONS, DESIGN_TYPE_OPTIONS, INDUSTRY_OPTIONS } from './designTemplate.interface';
...
const designTemplateSchema = new Schema<IDesignTemplate>(
    {
        ...
        fontIncluded: { type: Boolean, default: false },
