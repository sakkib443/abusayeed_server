/**
 * Blog Seed Script
 * Run this to create 6 demo blog posts
 * 
...
const seedBlogs = async () => {
    try {
        ...
        const demoBlogs = [
            ...
            {
                title: 'Graphic Design Trends to Follow in 2024',
                titleBn: '২০২৪ সালে অনুসরণীয় গ্রাফিক ডিজাইন ট্রেন্ডস',
                slug: 'demo-blog-graphic-design-trends-2024',
                excerpt: 'Stay ahead of the competition with the latest graphic design trends for 2024. From bold typography to minimalism and AI-driven design.',
                excerptBn: '২০২৪ সালের সর্বশেষ গ্রাফিক ডিজাইন ট্রেন্ডের সাথে প্রতিযোগিতায় এগিয়ে থাকুন। বোল্ড টাইপোগ্রাফি থেকে শুরু করে মিনিমালিজম এবং এআই-চালিত ডিজাইন পর্যন্ত।',
                content: `
                    <h2>Top Design Trends</h2>
                    <p>Graphic design is constantly evolving. In 2024, we see a shift towards more authentic, expressive, and technologically integrated designs.</p>
                    
                    <h3>1. Bold Typography</h3>
                    <p>Typography is no longer just for reading; it's a design element in itself. Expect to see oversized, experimental fonts that grab attention.</p>
                    
                    <h3>2. 3D Design & Surrealism</h3>
                    <p>With better tools, 3D elements are becoming more common in daily web design, creating immersive experiences.</p>
                    
                    <h3>3. AI-Driven Creativity</h3>
                    <p>AI tools are helping designers iterate faster and create complex patterns that were previously time-consuming.</p>
                    
                    <h2>Conclusion</h2>
                    <p>Embracing these trends can help your brand stand out and feel contemporary in a fast-paced digital world.</p>
                `,
                contentBn: `
                    <h2>সেরা ডিজাইন ট্রেন্ডস</h2>
                    <p>গ্রাফিক ডিজাইন ক্রমাগত বিকশিত হচ্ছে। ২০২৪ সালে, আমরা আরও খাঁটি, অভিব্যক্তিপূর্ণ এবং প্রযুক্তিগতভাবে সমন্বিত ডিজাইনের দিকে পরিবর্তন দেখছি।</p>
                    
                    <h3>১. বোল্ড টাইপোগ্রাফি</h3>
                    <p>টাইপোগ্রাফি আর শুধু পড়ার জন্য নয়; এটি নিজেই একটি ডিজাইন উপাদান।</p>
                    
                    <h3>২. থ্রিডি ডিজাইন</h3>
                    <p>উন্নত টুলের সাহায্যে, দৈনন্দিন ওয়েব ডিজাইনে থ্রিডি উপাদানগুলি আরও সাধারণ হয়ে উঠছে।</p>
                `,
                thumbnail: 'https://images.unsplash.com/photo-1572044162444-ad60f128bde2?w=800&h=600&fit=crop',
                category: blogCategory._id,
                tags: ['graphic design', 'trends', '2024', 'typography'],
                author: adminUser._id,
                authorRole: 'admin',
                status: 'published',
                isFeatured: true,
                ...
                readingTime: 4,
                wordCount: 380,
                metaTitle: 'Graphic Design Trends 2024',
                metaDescription: 'Explore the top graphic design trends for 2024 and stay ahead of the curve.',
                metaKeywords: ['graphic design', 'trends', '2024'],
